...
function StretchQuitModal({onClose, setLeftElapsedTime, setRightElapsedTime, leftElapsedTime, rightElapsedTime}) {
    const navigator = useNavigate();

    useEffect(() => {
        console.log("✅ leftElapsedTime changed:", leftElapsedTime);
    }, [leftElapsedTime]);
        ...
        <div className="fixed top-0 left-0 w-screen h-screen bg-black bg-opacity-60 z-[9999888] flex justify-center items-center pointer-events-auto">
            <div className="relative overflow-hidden">
                ...
                <div className="flex flex-col absolute bottom-32 left-1/2 -translate-x-1/2 z-[1000] text-center items-center gap-2">
                    <div className='text-[#455970] text-[30px] w-[500px] font-semibold'>그만두면 해파리를 <br></br>얻지 못해요</div>
                    <div className='text-[#455970] text-[20px] w-[500px] '>계속 해보는 게 어떨까요?</div>
                </div>
