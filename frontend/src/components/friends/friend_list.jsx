  ...
  return (
    <div className={styles.friends}>
      ...
      <div className={styles.friendsCategory}>
          ...
          <div className={styles.categorySelect} onClick={()=>{console.log('친구  눌림'); setSelectedTab('내 친구') }}>내 친구</div>
      ...
      <div className={styles.friendsTitles}>
        ...
        <div className={styles.userScroll}>
          <div className={styles.user}>
            <img src={testImg} className={styles.iimg}/>
            <div className={styles.userName}>
              <div className={styles.usertitle}>닉네임</div>
              <div className={styles.usercontent}>ㄹㅇ유저이름</div>
            </div>
            <div className={styles.userExercise}>
              <div className={styles.usertitle}>운동기록</div>
              <img src={workLog} className={styles.usercontent_btn}/>
            </div>
            <div className={styles.userDetail}>
              <div className={styles.usertitle}>한줄소개</div>
              <div className={styles.usercontent_detail}>ㄹㅇ한줄소개</div>
            </div>
            <img src={deleteBtn} className={styles.usercontentDeleteBtn}/>
          </div>
