    ...
    return (
        <div className="z-10 flex flex-col justify-start w-[300px] h-[200px] mt-4 left-11 ">
            ...
            <div className='text-start text-[#694B4B] text-[20px] pt-4 '>
                <div className="mb-4 cursor-pointer" onClick={()=>{setModal("1")}}> ▶ 개인정보 수집 및 카메라 접근 </div>
                <div className="mb-4 cursor-pointer" onClick={()=>{setModal("2")}}> ▶ 개인정보 보관 및 이용자의 권리 </div>
                <div className="mb-4 cursor-pointer" onClick={()=>{setModal("3")}}> ▶ 서비스 이용 제한 및 보안 정책 </div>
            </div>
