...
// 커스텀 훅
import { useModifyPwd } from '../hooks/use_modify_pwd';
...
function PwdModify(){
    ...
    const { changePassword, msg, setMsg } = useModifyPwd();
                ...
                <div>
                    ...
                    <div className='flex justify-center'>
                        <div className='flex w-[100px] h-[50px] bg-[#552F2F] rounded-2xl justify-center items-center cursor-pointer'>
                            <div className='text-[20px] text-white text-center' onClick={()=>changePassword(currentPwd, newPwd, confirmPwd)}>변경</div>
                        </div>
                    </div>
